...
class App:
    ...
    def run(self, run_vispy=True):
        ...
        Args:
            run_vispy (bool, optional): Whether to run the VisPy application. Defaults to True.
        """
    ...
    def close(self):
        """
        Closes the application by quitting the Vispy app and closing the main window.
        """
        self.vispy_app.quit()
